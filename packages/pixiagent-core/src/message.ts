...
): Array<z.infer<typeof ContentPartSchema>> {
 ...
 */
function concat(
  part1?: string | Array<z.infer<typeof ContentPartSchema>>,
  part2?: string | Array<z.infer<typeof ContentPartSchema>>,
): Array<z.infer<typeof ContentPartSchema>> {
  return [...toParts(part1), ...toParts(part2)];
}
